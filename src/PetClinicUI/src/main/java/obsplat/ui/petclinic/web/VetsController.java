...
public class VetsController {
    ...
    @Value("${vets-service-id://vets-service}")
    ...
    public ResponseEntity forward(@RequestBody(required = false) String body,
        ...
        String requestUrl = request.getRequestURI().replace("/petclinic-ui/api/vet", "/vets-service");
        log.info("Forward request with path " + request.getRequestURI() + " to vets service with path " + requestUrl);
