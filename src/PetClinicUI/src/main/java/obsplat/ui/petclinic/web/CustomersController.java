...
public class CustomersController {
    ...
    public ResponseEntity forward(@RequestBody(required = false) String body,
        ...
        String requestUrl = request.getRequestURI().replace("/petclinic-ui/api/customer", "/customers-service");
        log.info("Forward request with path " + request.getRequestURI() + " to customers service with path " + requestUrl);
